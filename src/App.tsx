...
const services = [
  {
    ...
    prices: [{ duration: "Both ears", price: "Contact me" }],
    info: {
      ...
      <section id="services" style={{ padding: "88px 24px", background: "#F4F9FA" }}>
        <div style={{ maxWidth: "1080px", margin: "0 auto" }}>
          ...
          <p className="fade-up" style={{ textAlign: "center", fontSize: "0.9rem", color: MUTED, marginTop: "20px" }}>
            One flat rate whichever methods are needed, up to 30 minutes, plus a reduced consultation-only fee if there's nothing to remove — get in touch for current pricing.
          </p>
